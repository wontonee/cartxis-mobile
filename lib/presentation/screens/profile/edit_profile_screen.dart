...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  DateTime _selectedDate = DateTime(1995, 10, 24);
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              Text(
                                                '${_selectedDate.month == 10 ? 'Oct' : _selectedDate.month == 1 ? 'Jan' : _selectedDate.month == 2 ? 'Feb' : _selectedDate.month == 3 ? 'Mar' : _selectedDate.month == 4 ? 'Apr' : _selectedDate.month == 5 ? 'May' : _selectedDate.month == 6 ? 'Jun' : _selectedDate.month == 7 ? 'Jul' : _selectedDate.month == 8 ? 'Aug' : _selectedDate.month == 9 ? 'Sep' : _selectedDate.month == 11 ? 'Nov' : 'Dec'} ${_selectedDate.day}, ${_selectedDate.year}',
                                                style: TextStyle(
                                                  fontSize: 16,
                                                  color: isDark
                                                      ? Colors.white
