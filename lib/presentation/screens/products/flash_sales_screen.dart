...
class FlashSalesScreen extends StatefulWidget {
  ...
  const FlashSalesScreen({super.key, this.onCartChanged});
...
class _FlashSalesScreenState extends State<FlashSalesScreen> {
  ...
  Future<void> _loadProducts() async {
    ...
    try {
      final products = await _productService.getOnSaleProducts(limit: _perPage);
      if (mounted) {
        setState(() {
          _products = products;
  ...
  Future<void> _loadMoreProducts() async {
    ...
    try {
      ...
      final newProducts = await _productService.getOnSaleProducts(
